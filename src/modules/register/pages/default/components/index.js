...
const RegisterView = ({
    ...
    return (
        <>
            <Typography variant="h1" type="bold" className={styles.title}>
                {t('common:form:registrationTitle')}
            </Typography>
            <form className={classNames('col-md-12', styles.container)} onSubmit={formik.handleSubmit}>
                <TextField
